...
<form action="{{ route('training-lists.update', $trainingList->id) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" step="0.01" name="amount_allocated" id="amount_allocated" value="{{ old('amount_allocated', $trainingList->amount_allocated) }}" class="form-control">
                </div>
                <div class="col-md-4 mb-3">
