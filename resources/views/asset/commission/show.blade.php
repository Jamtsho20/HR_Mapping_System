                ...
                <div class="row">
                    <div class="col-md-12">
                        <table style="width:100%;" class="simple-table">
                            <tbody>
                                <tr>
                                    <th style="width:35%;">Commission No <span class="pull-right d-none d-sm-block">:</span>
                                        &nbsp;&nbsp;</th>
                            ...
                            <tbody>
                                ...
                                @forelse ($commission->details as $detail)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{$detail->unitOfMeasurement->name ?? $detail->receivedSerial->requisitionDetail->grnItemDetail->item->uom }}
                                        </td>
