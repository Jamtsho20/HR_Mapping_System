    ...
    <div class="block-content">
        <form class="col-md-12 col-md-offset-3">
            <div class="form-group row">
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" name="company_name" required="required"
                        value="Tashi InfoComm Limited" readonly>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-12">
                    ...
                    <input class="form-control " id="address" readonly=""
                        value="Norzin Lam, Lungtenzampa BOD Complex, Post Box 1502 Thimphu, Bhutan" type="text">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txtcontectemail" readonly="" value="sashi.giri@tashicell.com"
                            type="email">
                    </div>
                </div>
            ...
            <div class="form-group row">
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="form-group">
                        ...
                        <div class="cal-icon">
                            <input class="form-control   " value="01" readonly="" id="txtfinancialyearformdate"
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="form-group">
                        ...
                        <div class="cal-icon">
                            <input class="form-control   " value="12" readonly="" id="txtfinancialyeartodate"
                                placeholder="dd-mmm-yyyy" type="text">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="form-group">
                        ...
                        <div class="cal-icon">
                            <input class="form-control   " value="01" readonly="" id="txtcalenderyearfromdate"
                                placeholder="dd-mmm-yyyy" type="text">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="form-group">
                        ...
                        <div class="cal-icon">
                            <input class="form-control   " value="12" readonly="" id="txtcalenderyeartodate"
                                placeholder="dd-mmm-yyyy" type="text">
                        </div>
                    </div>
                </div>             
            ...
            <div class="form-group row">
                <div class="col-12">                 
                    <label>Website </label>
                    <input class="form-control" id="txtwebsite" readonly="" value="https://www.tashicell.com/"
                        type="text">                 
                </div>
            </div>
        </form>
