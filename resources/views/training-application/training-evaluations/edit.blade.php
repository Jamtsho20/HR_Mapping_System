            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <input type="text" class="form-control" id="title" name="title" 
                           value="{{ old('title', $evaluation->question) }}" placeholder="e.g., Trainer Evaluation" required>
                    @error('title')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div id="questions-wrapper">
                        @forelse($evaluation->children as $sub)
                        <div class="question-item mb-3 border p-3">
                            <div class="row align-items-center">
                                <div class="col-md-10">
                                    <input type="text" name="questions[]" class="form-control" 
                                           placeholder="Enter sub question" value="{{ old('questions.'.$loop->index, $sub->question) }}" required>
                                </div>
                                <div class="col-md-1">
                                    <input type="number" name="sequences[]" class="form-control" 
                                           placeholder="Sequence" value="{{ old('sequences.'.$loop->index, $sub->sequence) }}" required>
                                </div>
