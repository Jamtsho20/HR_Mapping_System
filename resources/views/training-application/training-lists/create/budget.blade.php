<div class="card-body">
    <div class="row">
        <div class="col-md-3 mb-3">
            ...
            <select class="form-control" id="budget_0_type" name="budget[0][training_expense_type_id]" required>
        ...
        <div class="col-md-3 mb-3">
            ...
            <input type="text" step="0.01" name="budget[0][amount_allocated]" id="budget_0_amount"
                   value="{{ old('budget.0.amount_allocated') }}" class="form-control" required>
        </div>
        ...
        <div class="col-md-3 mb-3">
            ...
            <input type="text" step="0.01" name="budget[0][by_company]" id="budget_0_company"
                   value="{{ old('budget.0.by_company') }}" class="form-control" required>
        </div>
        ...
        <div class="col-md-3 mb-3">
            ...
            <input type="text" step="0.01" name="budget[0][by_sponsor]" id="budget_0_sponsor"
                   value="{{ old('budget.0.by_sponsor') }}" class="form-control" required>
        </div>
    </div>
</div>
