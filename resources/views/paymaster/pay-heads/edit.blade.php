            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" value="{{ $payHead->name }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="code">Code <span class="text-danger">*</span></label>
                        <input type="text" name="code" id="code" class="form-control" value="{{ $payHead->code }}" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group" id="calculated_on_wrapper"
                        @if(in_array($payHead->calculation_method, [1, 6, 7]))
                        style="display: none;"
                        @else
                        style="display: block;"
                        @endif>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group" id="pay_slab_wrapper"
                            @if($payHead->calculation_method == 3)
                            style="display: block;"
                            @else
                            style="display: none;"
                            @endif>
                        ...
                        <div class="form-group" id="pay_group_wrapper"
                            @if($payHead->calculation_method == 4)
                            style="display: block;"
                            @else
                            style="display: none;"
                            @endif>
                    ...
                    <div class="form-group" id="amount_wrapper"
                        @if(in_array($payHead->calculation_method, [1, 2, 5]))
                        style="display: block;"
                        @else
                        style="display: none;"
                        @endif>
                        <label for="amount">Amount <span class="text-danger">*</span></label>
                        <input type="number" name="amount" id="amount" class="form-control" value="{{ $payHead->amount }}">
                    </div>

                    <div class="form-group" id="formula_wrapper"
                        @if($payHead->calculation_method == 6)
                        style="display: block;"
                        @else
                        style="display: none;"
                        @endif>
