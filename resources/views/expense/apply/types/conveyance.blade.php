      ...
      <div class="row">
          ...
          <div class="col-md-4">
              <div class="form-group">
                  ...
                  <select class="form-control" id="travel_mode" name="mode_of_travel" required>
                      <option value="" disabled selected hidden>Select your option</option>
          ...
          <div class="col-md-4">
              <div class="form-group">
                  ...
                  <input type="date" class="js-datepicker form-control" name="travel_from_date" value="{{ old('travel_from_date') }}" placeholder="dd/mm/yy" required />
              </div>
          </div>
      </div>
      ...
      <div class="row">
          <div class="col-md-4">
              <div class="form-group">
                  ...
                  <input type="date" class="js-datepicker form-control" name="travel_to_date" value="{{ old('travel_to_date') }}" placeholder="dd/mm/yy" rerquired />
              </div>
          </div>
          <div class="col-md-4">
              <div class="form-group">
                  <label for="travel_from">Travel From<span class="text-danger">*</span></label>
                  <input type="text" class="form-control" name="travel_from" value="{{ old('travel_from') }}" required />
              </div>
          </div>
          <div class="col-md-4">
              <div class="form-group">
                  <label for="travel_to">Travel To<span class="text-danger">*</span></label>
                  <input type="text" class="form-control" name="travel_to" value="{{ old('travel_to') }}" required />
              </div>
          </div>
      </div>
  </div>