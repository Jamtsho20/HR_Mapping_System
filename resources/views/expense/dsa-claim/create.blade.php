                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="total_amount_adjusted"
                                name="total_amount_adjusted" value="{{ old('total_amount_adjusted') }}" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="net_payable_amount" name="net_payable_amount"
                                value="{{ old('net_payable_amount') }}" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="balance_amount" name="balance_amount"
                                value="{{ old('balance_amount') }}" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="file">Attachment (s)</label>
                            <input type="file" id="attachment" class="form-control" name="attachments">
                        </div>
            ...
            <div class="tab-pane">
                <div class="card">
                    <div class="card-body p-0">
                        <p class="text-danger large">*The total number of days may differ from the selected dates, as 0.5 is
                            subtracted for each half day.</p>
                            ...
                            <table id="qualifications" class="table table-condensed table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <input type="date" name="dsa_claim_detail[AAAAA][from_date]"
                                                class="form-control form-control-sm resetKeyForNew" />

                                        </td>
                                        <td class="text-center">
                                            <input type="text" name="dsa_claim_detail[AAAAA][from_location]"
                                                class="form-control form-control-sm resetKeyForNew" />
                                        </td>

                                        <td class="text-center">
                                            <input type="date" name="dsa_claim_detail[AAAAA][to_date]"
                                                class="form-control form-control-sm resetKeyForNew" />
                                        </td>
                                        <td class="text-center">
                                            <input type="text" name="dsa_claim_detail[AAAAA][to_location]"
                                                class="form-control form-control-sm resetKeyForNew" />
                                        </td>
                                        <td class="text-center">
                                            <input type="number" name="dsa_claim_detail[AAAAA][total_days]"
                                                class="form-control form-control-sm resetKeyForNew mycal hasDatepicker"
                                                step="0.5" />
                                        </td>

                                        <td class="text-center">
                                            <input type="number" name="dsa_claim_detail[AAAAA][daily_allowance]"
                                                value="{{ DAILY_ALLOWANCE }}"
                                                class="form-control form-control-sm resetKeyForNew" disabled />
                                        </td>
                                        <td class="text-center">
                                            <input type="number" name="dsa_claim_detail[AAAAA][travel_allowance]"
                                                class="form-control form-control-sm resetKeyForNew" />
                                        </td>
                                        <td class="text-center">
                                            <input type="number" name="dsa_claim_detail[AAAAA][total_amount]"
                                                class="form-control form-control-sm resetKeyForNew" disabled>
                                        </td>
                                        <td class="text-center">
