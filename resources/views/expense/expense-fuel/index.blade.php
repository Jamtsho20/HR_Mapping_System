...
@if ($privileges->create)
    @section('buttons')
    <a href="{{ route('expense-fuel.create')}}" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add New</a>
    @endsection
@endif
<div class="block-header block-header-default">
     @component('layouts.includes.filter')
        <div class="col-8 form-group">
            <input type="text" name="expensefuel" class="form-control" value="{{ request()->get('expensefuel') }}"placeholder="Search">
        </div>
    @endcomponent
