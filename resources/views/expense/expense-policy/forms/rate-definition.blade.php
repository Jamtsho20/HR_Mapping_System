                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <label class="custom-control custom-checkbox">
                                    <input id="select-all" type="checkbox" class="custom-control-input" name="example-checkbox1" value="">
                                    <span class="custom-control-label">Select All</span>
                                </label>

                                <select class="form-control select2 select2-hidden-accessible" data-placeholder="Choose Grade" multiple=""
                                    style="width: 100%" name="rate_definition_rule[AAAAA][mas_grade_step_id][]">
                                    @foreach($gradeSteps as $step)
                                    <option value="{{ $step->id }}" {{ (in_array($step->id, old('rate_definition_rule.AAAAA.mas_grade_step_id', []))) ? 'selected' : '' }}>
                                        {{ $step->name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <td class="text-center">
                                <select class="form-control" name="rate_definition_rule[AAAAA][region]">
                            ...
                            <td class="text-center">
                                <input type="number" placeholder="Enter limit amount" class="form-control"
                                    name="rate_definition_rule[AAAAA][limit_amount]" value="{{ old('rate_definition_rule.AAAAA.limit_amount') }}">
                            </td>
                            <td class="text-center">
                                <input type="date" placeholder="dd-mmm-yyyy" class="form-control"
                                    name="rate_definition_rule[AAAAA][start_date]" value="{{ old('rate_definition_rule.AAAAA.start_date') }}">
                            </td>
                            <td class="text-center">
                                <input type="date" placeholder="dd-mmm-yyyy" class="form-control"
                                    name="rate_definition_rule[AAAAA][end_date]" value="{{ old('rate_definition_rule.AAAAA.end_date') }}">
                            </td>
                            <td class="text-center">
                                <select class="form-control" name="rate_definition_rule[AAAAA][status]">
