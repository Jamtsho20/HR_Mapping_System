            ...
            <div class="row">
                <div class="col-md-12">
                    <table style="width:100%;" class="simple-table">
                        <tbody>
                            <tr>
                                <th style="width:35%;">Claim No <span class="pull-right d-none d-sm-block">:</span> &nbsp;&nbsp;</th>
                                <td style="padding-left:25px;"> {{ $dsa->dsa_claim_no }}</td>
                            </tr>
                            <tr>
                                <th style="width:35%;">Travel No <span class="pull-right d-none d-sm-block">:</span> &nbsp;&nbsp;</th>
                                <td style="padding-left:25px;"> {{ $dsa->travel->travel_authorization_no }}</td>
                            </tr>
                            <tr>
                                <th style="width:35%;">Advance No <span class="pull-right d-none d-sm-block">:</span> &nbsp;&nbsp;</th>
                                <td style="padding-left:25px;"> {{ $dsa->dsaadvance->advance_application_id??'-' }}</td>
                            </tr>
                            <tr>
                                <th style="width:35%;">Advance Amount <span class="pull-right d-none d-sm-block">:</span> &nbsp;&nbsp;</th>
                                <td style="padding-left:25px;"> {{ $dsa->total_amount??'-' }}</td>
                            </tr>
                            <tr>
                                <th style="width:35%;">Net Payable Amount <span class="pull-right d-none d-sm-block">:</span> &nbsp;&nbsp;</th>
                                <td style="padding-left:25px;"> {{ $dsa->net_payable_amount??'-' }}</td>
                            </tr>
                            <tr>
                                <th style="width:35%;">Balance Amount <span class="pull-right d-none d-sm-block">:</span> &nbsp;&nbsp;</th>
                            ...
                            <tr>
                                ...
                                <td style="padding-left:25px;"> @php
                                    ...
                                    <a href="{{ asset($file) }}" class="btn btn-sm btn-primary mb-1" target="_blank">
                    ...
                    <table style="width:100%;" class="simple-table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding-left:25px;"> {{ $dsa->status == -1 ? $dsa->expense_approved_by->name:'N/A'}} </td>
                            </tr>
                        </tbody>
                    </table>
                </div>
