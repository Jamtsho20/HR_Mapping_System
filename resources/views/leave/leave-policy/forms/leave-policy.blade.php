...
<div class="row">
    ...
    <div class="col-sm-4">
        <select class="form-control" id="ddlLeaveType" name="leave_policy[mas_leave_type_id]">
            ...
            <option value="{{ $leave->id }}" {{ old('leave_policy.mas_leave_type_id') == $leave->id ? 'selected' : '' }}>{{ $leave->name }}</option>
            @endforeach
        </select>
    </div>
...
<div class="row">
    ...
    <div class="col-sm-4">
        <input type="text" name="leave_policy[name]" value="{{ old('leave_policy.name')}}" placeholder="Policy name" class="form-control" required>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-sm-4">
        <textarea class="form-control" placeholder="Description" role="3" id="txtDesc" name="leave_policy[description]">{{ old('leave_policy.description')}}</textarea>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="cal-icon">
            <input type="date" name="leave_policy[start_date]" value="{{old('leave_policy.start_date')}}" placeholder="dd-mmm-yyyy" class="form-control mycal hasDatepicker" style="background-color: rgb(255, 255, 255);">
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="cal-icon">
            <input type="date" name="leave_policy[end_date]" value="{{old('leave_policy.end_date')}}" placeholder="dd-mmm-yyyy" class="form-control mycal" style="background-color: rgb(255, 255, 255);">
        </div>
    </div>
</div>
