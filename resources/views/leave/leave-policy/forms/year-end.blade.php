<div class="row">
    ...
    <div class=" col-6">
        <div class="row">
            ...
            <div class="col-3">
                <input type="text" id="txtCarryoverLimit1" min="0" maxlength="3" class="form-control mynumvalthreedigit year_proccessing" value="0" disabled name="year_end_processing[carryover_limit]" {{old('year_end_processing.carryover_limit')}}>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-6">
        <div class="row">
            ...
            <div class="col-3">
                <input type="text" id="txtMinBalance" min="0" maxlength="3" class="form-control mynumvalthreedigit year_proccessing" value="0" disabled name="year_end_processing[min_balance_required]" {{ old('year_end_processing.min_balance_required')}}>
            </div>
        </div>
        <div class="row">
...
<div class="row">
    ...
    <div class="col-6">
        <div class="row">
            ...
            <div class="col-3">
                <input type="text" id="txtCarryForwardLimit" min="0" maxlength="3" class="form-control mynumvalthreedigit year_proccessing" value="0" disabled name="year_end_processing[carry_forward_limit]" {{ old('year_end_processing.carry_forward_limit')}}>
            </div>
        </div>
    </div>
</div>
