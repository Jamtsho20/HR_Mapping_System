            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="d-flex" style="gap:4px">
                            <input type="date" class="js-datepicker form-control" id="from_date" name="from_date" value="{{ old('from_date') }}" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" required>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="d-flex" style="gap:4px">
                            <input type="date" class="js-datepicker form-control" id="to_date" name="to_date" value="{{ old('to_date') }}" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" readonly required>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="no_of_days_leave" name="no_of_days" value="{{ old('no_of_days') }}" placeholder="0.00" readonly required >
...
<script>
    ...
    // disabling half day option when half day option is selected from from day
    const disableHalfDayOption = () => { 
        if (!isHalfDayAllowed) return;
        const fromDate = $('#from_date').val();
        const toDate = $('#to_date').val();
        const fromDay = $('#ddl_from_day').val();
        const toDay = $('#ddl_to_day').val();
