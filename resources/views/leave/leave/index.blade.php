            ...
            <div class="col-6 form-group">
                <select class="form-control" id="leave_type" name="leave_type">
                    ...
                    <option value="{{ $type->id }}"
                        {{ request()->get('leave_type') == $type->id ? 'selected' : '' }}>{{ $type->name }}
                    </option>
                    @endforeach
                </select>
            </div>
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ \Carbon\Carbon::parse($leave->from_date)->format('d-M-Y') }}
                                                                </td>
                                                                <td>{{ \Carbon\Carbon::parse($leave->to_date)->format('d-M-Y') }}
                                                                </td>
                                                                ...
                                                                <td class="text-center">
                                                                    @if ($privileges->view)
                                                                    <a href="{{ url('leave/leave-apply/' . $leave->id) }}"
                                                                        class="btn btn-sm btn-outline-secondary"><i
                                                                            class="fa fa-list"></i> Detail</a>
                                                                    @endif
                                                                    @if ($privileges->edit)
                                                                    <a href="{{ url('leave/leave-apply/' . $leave->id . '/edit') }}"
                                                                    ...
                                                                    <a href="#"
                                                                        ...
                                                                        data-url="{{ url('leave/leave-apply/' . $leave->id) }}"><i
