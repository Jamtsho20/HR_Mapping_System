    ...
    <div class="block-header block-header-default">
        ...
        <div class="block-options">
            <div class="block-options-item">
                <a href="#" data-toggle="modal" data-target="#create-encashment" class="btn btn-sm btn-primary"><i
                        class="fa fa-plus"></i> Leave Encashment</a>
                <a href="#" data-toggle="modal" data-target="#create-leave" class="btn btn-sm btn-primary"><i
                        class="fa fa-plus"></i> Apply Leave</a>
                <a href="#" data-toggle="modal" data-target="#leave-balance" class="btn btn-sm btn-primary"><i
                        class="fa fa-calendar"></i> Leave Balance</a>
            </div>
        </div>
    </div>
                    ...
                    <div class="block-content">
                        ...
                        <div class="form-group row">
                            <div class="col-4">
                                ...
                                <input type="text" class="js-datepicker form-control" id="example-datepicker3"
                                    name="example-datepicker3" data-week-start="1" data-autoclose="true"
                            ...
                            <div class="col-4">
                                ...
                                <br><br>
                                <input style="margin-top:7px" type="text" class="form-control" name="no-of-days"
                                    required="required">
                            </div>
                        </div>
                        <div class="form-group row">
        ...
        <div class="modal-content">
            <form action="" method="POST">
                ...
                <div class="block block-themed block-transparent mb-0">
                    ...
                    <div class="block-content">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="number" class="form-control" id="example-hf-email" name="example-hf-email"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-6 col-form-label" for="leave_eligible">Leave Eligible For
                                Encashment</label>
                            <div class="col-lg-6">
                                <input type="number" class="form-control" id="example-hf-password"
                                    name="leave_eligible">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="number" class="form-control" id="example-hf-password" name="amount"
                                    required>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-alt-danger" data-dismiss="modal">Cancel</button>
                </div>
            </form>
        </div>
    </div>
