...
@section('content')
    @if ($privileges->create)
        @section('buttons')
            <a href="{{ route('loan-emi-deductions.create') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> New Loan / Device EMI</a>
        @endsection
    @endif
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Loan / Device Emis</h3>
                    </div>
                    <div class="card-body">
