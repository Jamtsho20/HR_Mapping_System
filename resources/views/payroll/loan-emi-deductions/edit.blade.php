            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <select name="mas_pay_head_id" id="mas_pay_head_id" class="form-control" required="required">
                        <option value="{{ $loanEMIDeduction->payHead->id }}">{{ $loanEMIDeduction->payHead->name }}</option>
                    </select>
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="date" class="form-control" name="start_date" value="{{ old('start_date', $loanEMIDeduction->start_date) }}"
                        required="required">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" name="loan_number" required="required" value="{{ $loanEMIDeduction->loan_number }}">
                </div>
                <div class="form-group col-md-6">
                    <label for="amount">EMI <span class="text-danger">*</span></label>
                    <input type="number" class="form-control" name="amount" value="{{ $loanEMIDeduction->amount }}" required="required">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6" id="recurring_months_container" style="{{ old('recurring', $loanEMIDeduction->recurring) ? '' : 'display: none;' }}">
                    <label for="recurring_months">Recurring no. of months <span class="text-danger">*</span></label>
                    <input type="number" class="form-control" name="recurring_months" id="recurring_months" value="{{ old('recurring_months', $loanEMIDeduction->recurring_months) }}">
                </div>
                <div class="form-group col-md-6">
