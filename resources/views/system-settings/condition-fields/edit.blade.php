@extends('layouts.app')
@section('page-title', 'Edit Condition Fields')
@section('content')

<form action="{{ url('system-setting/condition-fields/' . $field->id) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="card">
        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="mas_approval_head_id">
                            ...
                            <option value="{{ $head->id }}" {{ old('mas_approval_head_id',$field->mas_approval_head_id) == $head->id ? 'selected' : '' }}>
                                {{ $head->name }}
                            </option>
                            @endforeach
                        </select>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="label" value="{{ old('label',$field->label) }}" required>
                    </div>
                </div>
                <div class="col-md-4">
