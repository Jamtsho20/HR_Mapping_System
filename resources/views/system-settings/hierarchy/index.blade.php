...
@section('buttons')
<a href="{{ url('system-setting/hierarchies/create') }}" class="btn btn-primary"><i class="fa fa-plus"></i>New Hierarchy</a>
@endsection
@endif
@section('content')
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if ($privileges->edit)
                                    <a href="{{ url('system-setting/hierarchies/'. $hierarchy->id . '/edit') }}" class="btn btn-sm btn-rounded btn-outline-success f-s-10">
                                        <i class="fa fa-edit"></i> EDIT
                                    </a>
                                    @endif
                                    @if ($privileges->delete)
                                    <a href="#" class="delete-btn btn btn-sm btn-rounded btn-outline-danger f-s-10" data-url="{{ url('system-setting/hierarchies/'. $hierarchy->id) }}">
