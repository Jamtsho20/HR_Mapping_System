@extends('layouts.app')
@section('page-title', 'Asset Return Report')
@section('content')

    <div class="col-md-12 d-flex justify-content-end gap-2">
        <div class="d-flex gap-2">
            <a href="{{ route('good-return-report-excel.export', Request::query()) }}" data-toggle="tooltip"
                data-placement="top" title="Excel"><span><i class="fa fa-file-excel-o fa-lg"></i></span></a>
            <a href="{{ route('good-return-report-pdf.export', Request::query()) }}" data-toggle="tooltip" data-placement="top"
                title="PDF"><span><i class="fa fa-file-pdf-o fa-lg"></i></span></a>
            <a href="{{ route('good-return-report-print', Request::query()) }}" target="_blank"
    ...
    <div class="block-header block-header-default">
        @component('layouts.includes.filter')
            ...
            <div class="col-md-3 form-group">
                <label for="">Asset Return No:</label>
                <input type="text" class="form-control" name="return_no"
                    value="{{ old('return_no', request()->get('return_no')) }}" placeholder="Return No" />
            </div>
            <div class="col-md-3 form-group">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Asset return Report</h3>
                    </div>
                    <div class="card-body">
                    ...
                    @if ($assetReturnApplication->hasPages())
                        <div class="card-footer">
                            {{ $assetReturnApplication->links() }}
                        </div>
                    @endif
                </div>
            </div>
