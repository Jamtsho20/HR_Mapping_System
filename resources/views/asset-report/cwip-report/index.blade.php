                                        ...
                                        <tbody>
                                            ...
                                            @forelse($receivedSerials as $serial)
                                                    <tr>
                                                        ...
                                                        <td>{{ config('global.asset_class($serial->requisitionDetail?->grnItemDetail->item->item_group_id)') ?? $serial->requisitionDetail?->grnItemDetail->item->item_group_id ?? config('global.null_value')  }}</td>
