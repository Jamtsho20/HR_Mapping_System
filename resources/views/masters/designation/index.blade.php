                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if ($privileges->edit)
                                                <a href="{{ url('master/designations/'.$designation->id .'/edit') }}" data-name="{{ $designation->name }}" class="btn btn-sm btn-rounded btn-outline-success"><i class="fa fa-edit"></i> EDIT</a>
                                                @endif
