            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="grade_name" value="{{ old('grade_name', $grade->name) }}" required>
                    </div>
                </div>
                        ...
                        <table id="grade-steps" class="table table-bordered table-sm mb-0">
                            <thead class="bg-light">
                                <tr>
                                    ...
                                    <th width="20%">Starting Salary</th>
                                    <th width="15%">Increment</th>
                                    <th width="20%">Mid Salary</th>
                                    <th width="15%">Increment</th>
                                    <th width="20%">Ending Salary</th>
                                    <th width="6%"></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                @if(old('grade_steps') && count(old('grade_steps')) > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(isset($step['step_id']))
                                                <input type="hidden" name="grade_steps[{{ $stepIndex }}][step_id]" value="{{ $step['step_id'] }}">
                                            @endif
                                            <input type="text" 
                                    ...
                                    @endforeach
                                @else
                                    @foreach($grade->gradeSteps as $key => $step)
                                    <tr>
                                        <td class="text-center align-middle">{{ $key + 1 }}</td>
                                        <td>
                                            <input type="hidden" name="grade_steps[{{ $key }}][step_id]" value="{{ $step->id }}">
                                            <input type="text" 
                                                   name="grade_steps[{{ $key }}][step_name]" 
                                                   class="form-control form-control-sm" 
                                                   value="{{ old('grade_steps.' . $key . '.step_name', $step->name) }}" 
                                                   required>
                                        </td>
                                        <td>
                                            <input type="number" 
                                                   name="grade_steps[{{ $key }}][starting_salary]" 
                                                   class="form-control form-control-sm" 
                                                   value="{{ old('grade_steps.' . $key . '.starting_salary', $step->starting_salary) }}" 
                                                   min="0" 
                                                   step="0.01">
                                        </td>
                                        <td>
                                            <input type="number" 
                                                   name="grade_steps[{{ $key }}][increment]" 
                                                   class="form-control form-control-sm" 
                                                   value="{{ old('grade_steps.' . $key . '.increment', $step->increment) }}" 
                                                   min="0" 
                                                   step="0.01">
                                        </td>
                                        <td>
                                            <input type="number" 
                                                   name="grade_steps[{{ $key }}][mid_salary]" 
                                                   class="form-control form-control-sm" 
                                                   value="{{ old('grade_steps.' . $key . '.mid_salary', $step->mid_salary) }}" 
                                                   min="0" 
                                                   step="0.01">
                                        </td>
                                        <td>
                                            <input type="number" 
                                                   name="grade_steps[{{ $key }}][increment2]" 
                                                   class="form-control form-control-sm" 
                                                   value="{{ old('grade_steps.' . $key . '.increment2', $step->increment2) }}" 
                                                   min="0" 
                                                   step="0.01">
                                        </td>
                                        <td>
                                            <input type="number" 
                                                   name="grade_steps[{{ $key }}][ending_salary]" 
                                                   class="form-control form-control-sm" 
                                                   value="{{ old('grade_steps.' . $key . '.ending_salary', $step->ending_salary) }}" 
                                                   min="0" 
                                                   step="0.01">
                                        </td>
                                        <td class="text-center align-middle">
