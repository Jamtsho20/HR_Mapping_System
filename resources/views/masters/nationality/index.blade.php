                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if ($privileges->edit)
                                                <a href="{{ url('master/nationalities/'.$nationality->id .'/edit') }}" data-name="{{ $nationality->name }}" class=" btn btn-sm btn-rounded btn-outline-success"><i class="fa fa-edit"></i> EDIT</a>
                                                @endif
