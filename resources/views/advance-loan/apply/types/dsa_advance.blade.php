    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="date" class="js-datepicker form-control" name="from_date" placeholder="dd/mm/yy">
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label for="to_date">To Date <span class="text-danger">*</span></label>
                <input type="date" class="js-datepicker form-control" name="to_date" placeholder="dd/mm/yy">
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
