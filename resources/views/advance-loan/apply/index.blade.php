...
<div class="block">
    <div class="block-header block-header-default">
        ...
        <div class="col-8 form-group">
            <input type="text" name="advance" class="form-control" value="{{ request()->get('advance') }}"
                placeholder="Search">
        </div>
        @endcomponent
        <div class="block-options">
            <div class="block-options-item">
                <a href="#" data-toggle="modal" data-target="#create-expense" class="btn btn-sm btn-primary"><i
                        class="fa fa-plus"></i>Apply Advance</a>
                    ...
                    <div class="block-content">
                        <div class="form-group row">
                            <div class="col-4">
                                ...
                                <input type="number" class="form-control" placeholder="Generating...." name="advance_no"
                        ...
                        <div class="form-group row" id="dsa_advance" style="display:none;">
                            <div class="col-4">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" class="js-datepicker form-control " id="example-datepicker2"
                                    name="example-datepicker2" data-week-start="1" data-autoclose="true"
                        ...
                        <div class="form-group row" id="general_imprest_advance" style="display:none;">
                            <div class="col-4">
                                <label for="amount">Amount<span class="text-danger">*</span></label>
                        ...
                        <!-- SIFA LOAN -->
                        <div class="form-group row" id="sifa_loan" style="display:none;">
                            <div class="col-4">
                                <label for="amount">Amount<span class="text-danger">*</span></label>
                                <input type="number" class="form-control" name="amount" required="required">
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                <input type="number" class="form-control" name="total_amount" required="required"
                                    readonly="readonly">
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                <input type="number" class="form-control" name="monthly_emi" required="required"
                                    readonly="readonly">
                            </div>
                        ...
                        <!-- SAMSUNG EMI -->
                        <div class="form-group row" id="samsung_emi" style="display:none;">
                            <div class="col-12">
