    ...
    <div class="form-group row">
        <div class="col-md-2">
            <div class="form-group form-focus select-focus">
                ...
                <input type="text" placeholder="Eg. XX12" class="form-control floating myclass input_search"
                    id="txt_empcode">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group form-focus select-focus">
                ...
                <input type="text" placeholder="Eg. John" class="form-control floating myclass input_search"
                    id="txt_empname">
            </div>
        </div>
        <div class="col-md-2">
