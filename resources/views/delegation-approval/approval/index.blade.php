@extends('layouts.app')
@section('page-title', 'Advance Delegation Approval')
@section('content')
...
<div class="block">
    <div class="block-header block-header-default">
        ...
        <div class="col-8 form-group">
            <input type="text" name="advancedelegationapproval" class="form-control" value="{{ request()->get('advancedelegationapproval') }}"
                placeholder="Search">
        </div>
        @endcomponent
