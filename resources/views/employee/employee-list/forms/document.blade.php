        ...
        <div class="card-body">
            <div class="row">
                <div class="form-group col-md-12">
                    <label for="document1">Contract of Employment<span class="text-danger">*</span></label>
                    <input type="file" class="form-control form-control-sm" name="documents[employment_contract]" required>
                </div>
                <br>
                <div class="form-group col-md-12">
                    <label for="document2">Non-Disclosure Agreement<span class="text-danger">*</span></label>
                    <input type="file" class="form-control form-control-sm" name="documents[non_disclosure_aggrement]" required>
                </div>
                <br>
                <div class="form-group col-md-12">
                    <label for="document3">Job Responsibilities<span class="text-danger">*</span></label>
