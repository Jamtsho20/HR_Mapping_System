        ...
        <div class="card-body">
            <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control form-control-sm" name="personal[first_name]" value="{{ old('personal.first_name', isset($employee) ? $employee->first_name : '')}}" required>
                </div>
                <div class="form-group col-md-4">
                    <label for="middle_name">Middle Name</label>
                    <input type="text" class="form-control form-control-sm" name="personal[middle_name]" value="{{ old('personal.middle_name', isset($employee) ? $employee->middle_name : '') }}">
                </div>
                <div class="form-group col-md-4">
                    <label for="last_name">Last Name</label>
                    <input type="text" class="form-control form-control-sm" name="personal[last_name]" value="{{old('personal.last_name', isset($employee) ? $employee->last_name : '') }}">
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="date" class="form-control form-control-sm" name="personal[dob]" value="{{old('personal.dob', isset($employee) ? $employee->dob : '')}}" required>
                </div>
                <div class="form-group col-md-4">
                    <label for="birth_place">Birth Place <span class="text-danger">*</span></label>
                    <div class="input-group input-group-sm">
                        <input type="text" class="form-control form-control-sm" name="personal[birth_place]" value="{{ old('personal.birth_place', isset($employee) ? $employee->birth_place : '') }}" required>
                    </div>
                </div>
                <div class="form-group col-md-4">
                    <label for="birth_country">Birth Country <span class="text-danger">*</span></label>
                    <div class="input-group input-group-sm">
                        <input type="text" class="form-control form-control-sm" name="personal[birth_country]" value="{{ old('personal.birth_country', isset($employee )?$employee->birth_country: '')}}" required>
                    </div>
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="email" class="form-control form-control-sm" name="personal[email]" value="{{old('personal.email', isset($employee) ? $employee->email : '')}}" required>
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="date" class="form-control form-control-sm" name="personal[date_of_appointment]" value="{{old('personal.date_of_appointment', isset($employee) ? $employee->date_of_appointment : '')}}" required>
                </div>
                <div class="form-group col-md-4">
                    <label for="cid_copy">CID Copy <span class="text-danger">*</span></label>
                    <input type="file" class="form-control form-control-sm" name="personal[cid_copy]" @if(empty($employee->cid_copy)) required @endif>
                ...
                <div class=" form-group col-md-4">
                    ...
                    <label class="custom-switch">
                        ...
                        <input type="checkbox"
                            ...
                            value="1"
                            {{ old('personal.is_active', isset($employee) ? $employee->is_active : '') == '1' ? 'checked' : '' }} />
