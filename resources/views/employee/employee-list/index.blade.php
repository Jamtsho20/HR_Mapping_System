...
<div class="block-header block-header-default">
    ...
    <div class="col-md-3 form-group">
        <select class="form-control select2 select2-hidden-accessible" data-placeholder="Select Status"
            tabindex="-1" name="is_active">
            <option value="" disabled selected hidden>Select Status</option>
            <option value="Active" {{ request()->get('is_active') == 'Active' ? 'selected' : '' }}>Active</option>
            <option value="Inactive" {{ request()->get('is_active') == 'Inactive' ? 'selected' : '' }}>Inactive</option>
        </select>
    </div>
