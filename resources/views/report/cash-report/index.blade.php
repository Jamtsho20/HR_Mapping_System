@extends('layouts.app')
@section('page-title', 'Cash Report')
@section('content')

    <div class="col-md-12 d-flex justify-content-end gap-2">
        <div class="d-flex gap-2">
            <a href="{{ route('cash-report-excel.export', Request::query()) }}" data-toggle="tooltip" data-placement="top"
                title="Excel"><span><i class="fa fa-file-excel-o fa-lg"></i></span></a>
            <a href="{{ route('cash-report-pdf.export', Request::query()) }}" data-toggle="tooltip" data-placement="top"
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    @forelse($cashes as $cash)
                                                        <tr>
                                                            <td>{{ ($cashes->currentPage() - 1) * $cashes->perPage() + $loop->iteration }}
                                                            </td>
