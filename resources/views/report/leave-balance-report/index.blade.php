...
<div class="col-md-12 d-flex justify-content-end gap-2">
    <div class="d-flex gap-2">
        <a href="{{route('leave-balance-excel.export',Request::query())}}" data-toggle="tooltip" data-placement="top" title="Excel"><span><i class="fa fa-file-excel-o fa-lg"></i></span></a>
        <a href="{{route('leave-balance-pdf.export', Request::query())}}" data-toggle="tooltip" data-placement="top" title="PDF"><span><i class="fa fa-file-pdf-o fa-lg"></i></span></a>
        <a href="{{ route('leave-balance-report-print',Request::query()) }}" target="_blank" onclick="openPrintPreview(event)">
...
<div class="block-header block-header-default">
    ...
    <div class="col-2 form-group">
        <select name="mas_leave_type_id" class="form-control ">
            <option value="" disabled="" selected="" hidden="">Select Leave Type</option>
            @foreach($leaveTypes as $type)
            <option value="{{  $type->id }}" {{ request()->get('mas_leave_type_id') ==  $type->id ? 'selected' : '' }}>
                {{$type->name }}
            </option>
            @endforeach
        </select>
