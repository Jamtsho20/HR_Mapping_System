...
@section('buttons')
    <a href="{{ url('report/dsa-settlement-report/') }}" class="btn btn-primary"><i class="fa fa-reply"></i> Back to DSA
        Settlement
        Report</a>
@endsection
@section('content')
                        ...
                        <div class="col-md-12">
                            <table style="width:100%;" class="simple-table">
                                <tbody>
                                    ...
                                    <tr>
                                        <th style="width:35%;">Advance No <span
                                                class="pull-right d-none d-sm-block">:</span>
                                            &nbsp;&nbsp;</th>
                                        <td style="padding-left:25px;">
                                            {{ $dsa->dsaadvance->advance_application_id ?? config('global.null_value') }}
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th style="width:35%;">Attachment <span
                                                class="pull-right d-none d-sm-block">:</span>
                                            &nbsp;&nbsp;</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th style="width:35%;">Advance No(s) <span class="pull-right d-none d-sm-block">:</span>
                                    &nbsp;&nbsp;</th>
                                <td style="padding-left:25px;">
                                    {{ !empty($advanceNosString) ? $advanceNosString : config('global.null_value') }}</td>
                            </tr>
                            <tr>
                                            ...
                                            <tr class="travel-auth-${travelAuthGroupClass} bg-light">
                                                ...
                                                <td colspan="4" style="padding-left:25px;">
                                                    @if ($detail->attachment)
                                                        <a href="{{ asset(normalizePathForDisplay($detail->attachment)) }}"
                                            ...
                                            <tr class="travel-auth-${travelAuthGroupClass} last-row">
                                                ...
                                                <td colspan="1" class="text-center"
                                                    ...
                                                    <input type="hidden" id="total_days"
                                                        name="total_days[{{ $detail->travel_authorization_id }}]"
                                                ...
                                                <td colspan="1" class="text-center"
                                                    style="color: black;  font-weight: bold;">
                                                    <input type="number" id="ta_amount"
                                                        style="color: black;  font-weight: bold;" class="form-control"
                                                        name="ta_amount[{{ $detail->travel_authorization_id }}]"
                                                        value="{{ $detail->ta_amount }}" readonly>
                                                    <input type="hidden" id="advance_amount"
                                                        name="advance_amount[{{ $detail->travel_authorization_id }}]"
                                                        value="{{ $detail->advance_amount ?? 0 }}">
                                                </td>
                                                <td colspan="1" class="text-center" style="color: black;">
