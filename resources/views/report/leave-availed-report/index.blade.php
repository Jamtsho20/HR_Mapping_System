...
@section('content')
    ...
    <div class="col-md-12 d-flex justify-content-end gap-2">
        <div class="d-flex gap-2">
            <a href="{{ route('leave-availed-excel.export', Request::query()) }}" data-toggle="tooltip" data-placement="top"
                title="Excel"><span><i class="fa fa-file-excel-o fa-lg"></i></span></a>
            <a href="{{ route('leave-availed-pdf.export', Request::query()) }}" data-toggle="tooltip" data-placement="top"
                title="PDF"><span><i class="fa fa-file-pdf-o fa-lg"></i></span></a>
            <a href="{{ route('leave-availed-report-print', Request::query()) }}" target="_blank"
    ...
    <div class="block-header block-header-default">
        @component('layouts.includes.filter')
            ...
            <div class="col-2 form-group">
                <select name="leave_type" class="form-control select2 select2-hidden-accessible"
                    data-placeholder="Select Leave Type" tabindex="-1">
                                                        ...
                                                        <tbody>
                                                            @forelse($leaveReports as $report)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $report->employee->empJob->designation->name }}
                                                                    </td>
                                                                    <td>{{ $report->employee->empJob->department->name }}
                                                                    </td>
                                                            ...
                                                            @empty
                                                                <tr>
                                                                    <td colspan="9" class="text-center text-danger">No
                                                                        leave availed report found</td>
                                                                </tr>
                                                            @endforelse
                                                        </tbody>
                                                    </table>
