...
@section('content')
    ...
    <div class="col-md-12 d-flex justify-content-end gap-2">
        <div class="d-flex gap-2">
            <a href="{{ route('sss-report-excel.export', Request::query()) }}" data-toggle="tooltip" data-placement="top"
                title="Excel"><span><i class="fa fa-file-excel-o fa-lg"></i></span></a>
            <a href="{{ route('sss-report-pdf.export', Request::query()) }}" data-toggle="tooltip" data-placement="top"
                title="PDF"><span><i class="fa fa-file-pdf-o fa-lg"></i></span></a>
            <a href="{{ route('sss-report-print', Request::query()) }}" target="_blank"
            ...
            <div class="col-3 form-group">
                <select name="employee" class="form-control select2 select2-hidden-accessible"
                    ...
                    @foreach ($employee as $name)
                        <option value="{{ $name->id }}" {{ request()->get('employee') == $name->id ? 'selected' : '' }}>
                            {{ $name->name }}
                        </option>
                    @endforeach
                </select>
