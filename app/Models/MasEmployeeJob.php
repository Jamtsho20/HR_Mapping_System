...
class MasEmployeeJob extends Model
{
    ...
    protected $fillable = [
        ...
        'mas_employment_type_id', 'bank_code','immediate_supervisor', 'mas_office_id', 'basic_pay', 'salary_disbursement_mode', 'bank', 'account_number', 'pf_number', 'tpn_number', 'gis_policy_number'
    ];
