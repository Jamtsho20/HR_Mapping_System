...
class ExpenseApplicationController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $expenseApplications = ExpenseApplication::with(['type:id,name', 'travelType:id,name', 'histories:id,application_id,action_performed_by,application_type,status',  'histories.actionPerformer:id,name,username', 'vehicle:id,vehicle_no', 'vehicleType:id,name'])->filter($request)->createdBy()->orderBy('created_at', 'desc')->get();
