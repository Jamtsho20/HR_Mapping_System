...
class EmployeeController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('employee/employee-list.create', compact('dzongkhags', 'gewogs', 'departments', 'designations', 'gradeSteps', 'employmentTypes', 'qualifications'));
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $this->saveAddress($request->permenant_address, $request->current_address);
            $this->saveJob($request->job);
    ...
    private function saveAddress($permenantAddress, $currentAddress){
    ...
    private function saveQualifications($qualifications){
        // $empQualification = new MasEmployeeQualification();
        $user = new User();
        $qualification = [];
    ...
    private function saveTrainings($trainings){
        // $empTraining = new MasEmployeeTraining();
        $user = new User();
        $training = [];
        foreach($trainings as $key => $value){
            $trainingCertificate = $value->hasFile('certificate') ? uploadImageToDirectory($value->file('certificate'), '/images/emp-training-cert') : null;
            $training[] = [
                'title' => $value['title'],
    ...
    private function saveExperiences($experiences){
    ...
    private function saveDocuments($doc){
        // $empDoc = new MasEmployeeDocument();
        $user = new User();
        $empContract = "";
