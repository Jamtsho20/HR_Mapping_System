...
class CreditEmpLeave extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'credit-emp-leave {leave_type_id, gender}';
     ...
     * @var string
     */
    protected $description = 'Credit employee leave based on leave policy';
