...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('application_histories', function (Blueprint $table) {
            ...
            $table->foreignId('approver_role_id')->index()->constrained('roles')->restrictOnDelete()->cascadeOnUpdate();
            $table->foreignId('approver_emp_id')->index()->constrained('mas_employees')->restrictOnDelete()->cascadeOnUpdate();
