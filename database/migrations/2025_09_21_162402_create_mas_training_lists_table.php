...
return new class extends Migration
{
    ...
    {
        Schema::create('mas_training_lists', function (Blueprint $table) {
            $table->id();
            ...
            $table->date('end_date');
            $table->foreignId('department_id')->nullable()->constrained('mas_departments')->cascadeOnUpdate()->restrictOnDelete()->comment('sometimes trainig will be dedicated to spwecific dept if null then whole employee are eligible for it.');
            $table->decimal('amount_allocated', 12, 2)->nullable();
    ...
    {
        Schema::dropIfExists('mas_training_lists');
    }
};
