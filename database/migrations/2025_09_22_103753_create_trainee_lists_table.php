...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('trainee_lists', function (Blueprint $table) {
            ...
            $table->foreignId('department_id')->index()->constrained('mas_departments')->cascadeOnUpdate()->restrictOnDelete();
            $table->foreignId('designation_id')->index()->constrained('mas_designations')->cascadeOnUpdate()->restrictOnDelete();
