...
class SystemSubMenusTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('system_sub_menus')->insert([
            ...
            ['system_menu_id' => 4, 'name' => 'Apply', 'route' => 'expense/apply', 'display_order' => 1],
            ['system_menu_id' => 4, 'name' => 'Approval', 'route' => 'expense/approval', 'display_order' => 2],
            ['system_menu_id' => 4, 'name' => 'DSA Claim/Settlement', 'route' => 'expense/dsa-claim-settlement', 'display_order' => 3],
            ['system_menu_id' => 4, 'name' => 'DSA Approval', 'route' => 'expense/dsa-approval', 'display_order' => 5],
            ['system_menu_id' => 4, 'name' => 'DSA Approval', 'route' => 'expense/dsa-approval', 'display_order' => 6],
            ['system_menu_id' => 4, 'name' => 'Transfer Claim', 'route' => 'expense/transfer-claim', 'display_order' => 7],
            ['system_menu_id' => 4, 'name' => 'Transfer Claim Approval', 'route' => 'expense/transfer-claim-approval', 'display_order' => 8],
            ['system_menu_id' => 4, 'name' => 'Expense Fuel /Fuel Claim', 'route' => 'expense/expense-fuel', 'display_order' => 9],
            ['system_menu_id' => 4, 'name' => 'Fuel Expense Approval', 'route' => 'expense/fuel-approval', 'display_order' => 10],

            //sub menu for leaves
            ['system_menu_id' => 5, 'name' => 'Apply', 'route' => 'leave/leave-history', 'display_order' => 1],
            ...
            ['system_menu_id' => 7, 'name' => 'Attendance Register', 'route' => 'attendance/attendance-register', 'display_order' => 2],
            ['system_menu_id' => 7, 'name' => 'Attendance Summary', 'route' => 'attendance/attendance-summary', 'display_order' => 3],
            ...
            ['system_menu_id' => 9, 'name' => 'Employee', 'route' => 'employee/employee-lists', 'display_order' => 1],

            //submenu for sifa
            ['system_menu_id' => 10, 'name' => 'SIFA', 'route' => 'sifa/sifa-registration', 'display_order' => 1],
