...
class SystemMenusTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('system_menus')->insert([
            ...
            ['id' => 5, 'name' => 'Employee', 'icon' => 'fa-users', 'display_order' => 5],
            // ['id' => 11, 'name' => 'Sifa', 'icon' => 'fa-user', 'display_order' => 11],
            ['id' => 6, 'name' => 'Reports', 'icon' => 'fa-flag', 'display_order' => 6],
            ...
            ['id' => 10, 'name' => 'Man Power Requisition', 'icon' => 'fa-briefcase', 'display_order' => 10],
